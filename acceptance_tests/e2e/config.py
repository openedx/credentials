...
try:
    ...
    raise RuntimeError(
        "You must provide a valid URL root for the Credentials Service to run acceptance tests."
    )

CREDENTIALS_API_URL = os.environ.get(
    "CREDENTIALS_API_URL", CREDENTIALS_ROOT_URL + "/api/v2/"
)
