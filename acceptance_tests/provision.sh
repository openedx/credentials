...
# Note that this leaves you with a user with the hardcoded password 'edx' - so don't run this in production,
# obviously (though it does hardcode the 'local' setting).
