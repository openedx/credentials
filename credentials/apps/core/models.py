...
class SiteConfiguration(models.Model):
    ...
    tos_url = models.URLField(
        verbose_name=_("Terms of Service URL"), blank=False, null=True,
    )
    privacy_policy_url = models.URLField(
        verbose_name=_("Privacy Policy URL"), blank=False, null=True,
    )
    homepage_url = models.URLField(
        verbose_name=_("Homepage URL"), blank=False, null=True,
    )
    company_name = models.CharField(
        verbose_name=_("Company Name"), max_length=255, blank=False, null=True,
    )
    ...
    twitter_username = models.CharField(
        ...
        help_text=_(
            "Twitter username included in tweeted credentials. Do NOT include @."
        ),
        max_length=15,
        blank=True,
        null=True,
    ...
    def user_api_client(self):
        ...
        return EdxRestApiClient(
            self.user_api_url, jwt=self.access_token, append_slash=False
        )
    ...
    def get_user_api_data(self, username):
        ...
        """
        cache_key = "user.api.data.{}".format(
