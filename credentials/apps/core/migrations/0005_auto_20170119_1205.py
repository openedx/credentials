...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RemoveField(model_name="siteconfiguration", name="theme_scss_path",),
        migrations.AddField(
            model_name="siteconfiguration",
            name="certificate_help_url",
            field=models.URLField(
                help_text="URL of page for questions about certificates",
                null=True,
                verbose_name="Certificate Help URL",
            ),
        ),
        migrations.AddField(
            model_name="siteconfiguration",
        ...
        migrations.AddField(
            ...
            name="platform_name",
            field=models.CharField(
                help_text="Name of your Open edX platform",
                max_length=255,
                null=True,
        ...
        migrations.AddField(
            ...
            field=models.URLField(
                help_text="URL of page for information on verified certificates",
                null=True,
        ...
        migrations.AlterField(
            ...
            name="lms_url_root",
            field=models.URLField(
                help_text="Root URL of this site's LMS (e.g. https://courses.stage.edx.org)",
                null=True,
                verbose_name="LMS base url for custom site",
            ),
        ),
    ]
