    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        max_length=255,
                        validators=[
                            credentials.apps.credentials.models.validate_course_key
                        ],
                    ),
                ),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        default="awarded",
                        max_length=255,
                        choices=[("awarded", "awarded"), ("revoked", "revoked")],
                    ),
                ),
                (
                    "download_url",
                    models.CharField(
                        help_text="Download URL for the PDFs.",
                        max_length=255,
                        null=True,
                        blank=True,
                    ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                blank=True,
                to="credentials.CertificateTemplate",
                null=True,
                on_delete=models.CASCADE,
            ),
        ),
        ...
        migrations.AlterUniqueTogether(
            name="usercredential",
            unique_together=set(
                [("username", "credential_content_type", "credential_id")]
            ),
        ),
        migrations.AlterUniqueTogether(
            name="coursecertificate",
