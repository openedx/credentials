...
class SignatoryTests(TestCase):
    ...
    def create_clean(self, file_obj):
        ...
        """
        Signatory(
            name="test_signatory", title="Test Signatory", image=file_obj
        ).full_clean()
    ...
    def test_good_image(self):
        ...
        Signatory(
            name="test_signatory", title="Test Signatory", image=good_image
        ).full_clean()
    ...
    def test_signatory_file_saving(self):
        ...
        signatory = Signatory.objects.create(
            name="test name", title="Test Signatory", image=image
        )
...
class CourseCertificateTests(SiteMixin, TestCase):
    ...
    def test_invalid_course_key(self):
        ...
        self.assertEqual(
            context.exception.message_dict, {"course_id": ["Invalid course key."]}
        )
...
class ProgramCertificateTests(SiteMixin, TestCase):
    ...
    def test_str(self):
        ...
        self.assertEqual(
            str(instance), "ProgramCertificate: " + str(instance.program_uuid)
        )
    ...
    def test_program_details(self, use_org_name, credential_title):
        ...
        with mock.patch.object(
            SiteConfiguration, "get_program", return_value=body
        ) as mock_method:
    ...
    def test_get_program_api_data(self):
        ...
        with mock.patch.object(
            SiteConfiguration, "get_program", return_value=expected
        ) as mock_method:
