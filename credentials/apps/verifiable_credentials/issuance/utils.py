...
async def didkit_verify_credential(credential, proof_options):
    ...
    """
    return await didkit.verify_credential(credential, proof_options)
...
async def didkit_verify_presentation(presentation, proof_options):
    ...
    """
    return await didkit.verify_presentation(presentation, proof_options)
...
async def didkit_generate_ed25519_key():
    ...
    """
    return await didkit.generate_ed25519_key()
...
async def didkit_key_to_did(*, jwk, method_pattern="key"):
    ...
    """
    return await didkit.key_to_did(jwk=jwk, method_pattern=method_pattern)
