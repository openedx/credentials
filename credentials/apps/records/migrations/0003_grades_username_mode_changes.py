...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterUniqueTogether(
            name="usergrade", unique_together=set([("username", "course_run")]),
        ),
        migrations.RemoveField(model_name="usergrade", name="user",),
        migrations.RemoveField(model_name="usergrade", name="mode",),
        migrations.AddField(
            model_name="usergrade",
            name="verified",
