...
class CopyCatalogCommandTests(SiteMixin, TestCase):
    ...
    def test_page_size(self):
        ...
        self.mock_access_token_response()
        self.mock_programs_response(
            self.wrap_programs([self.PROGRAMS[0]], final=False), 1, 1
        )
        self.mock_pathways_response(
            self.wrap_pathways([self.PATHWAYS[0]], final=False), page_size=1
        )
        self.mock_programs_response(self.wrap_programs([self.PROGRAMS[1]]), 2, 1)
        self.mock_pathways_response(
            self.wrap_pathways([self.PATHWAYS[1]]), page=2, page_size=1
        )
    ...
    def test_update(self):
        ...
        OrganizationFactory(
            site=self.site, uuid="33f0dded-fee9-4dec-a333-b9d8c2c82bd2", key="OldX"
        )
        ProgramFactory(
            site=self.site,
            uuid="33f0dded-fee9-4dec-a333-c9d8c2c82bd5",
    ...
    def test_keep_old_data(self):
        ...
        org = OrganizationFactory(
            site=self.site, uuid="44f0dded-fee9-4dec-a333-b9d8c2c82bd2", key="OldX"
        )
        ...
        org = Organization.objects.get(
            uuid="44f0dded-fee9-4dec-a333-b9d8c2c82bd2", key="OldX"
        )
