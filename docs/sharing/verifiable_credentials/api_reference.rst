...
.. Maintainership note:
   Consider replacing this manually maintained page with autogenerated API documentation in a follow-up PR.
   If you do that, update ``docs/credentials_api.rst`` at the same time so credential API references stay consistent.
